...
import com.palfib.vanilla.wow.armory.service.CharacterTalentService;
import lombok.val;
...
public class CharacterTalentCommandService extends AbstractInteractiveCommandService {
    ...
    private Map<String, DiscordQuestionWrapper> generateQuestionWrappers(final String characterName, final List<String> argList) {
        ...
        map.put(CHARACTER_NAME, new DiscordQuestionWrapper("What is your character's name?", this::validateSimpleName));
        ...
        map.put(NAME, new DiscordQuestionWrapper("What is your spec's name?", this::validateSimpleName));
    ...
    private void handleAnswers(final DiscordQuestionSequenceWrapper questionSequenceWrapper) {
        ...
        try {
            ...
            val characterTalentWrapper = CharacterTalentWrapper.builder()
